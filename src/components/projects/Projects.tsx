...
const projects: Project[] = [
  {
    ...
    backgroundImageUrl: "/assets/lashes-studio/lashes-studio-landing-big.png",
    images: [
      "/assets/lashes-studio/lashes-studio-landing-big.png",
      ...
      "/assets/lashes-studio/lashes-studio-forgotten-password.png",
      "/assets/lashes-studio/lashes-studio-admin-dashboard.png",
      "/assets/lashes-studio/lashes-studio-admin-appointments.png",
      "/assets/lashes-studio/lashes-studio-admin-appointments-search.png",
      "/assets/lashes-studio/lashes-studio-admin-appointment.png",
      "/assets/lashes-studio/lashes-studio-cancel-appointment.png",
      "/assets/lashes-studio/lashes-studio-reschedule.png",
      "/assets/lashes-studio/lashes-studio-reschedule2.png",
      "/assets/lashes-studio/lashes-studio-admin-clients.png",
      "/assets/lashes-studio/lashes-studio-client-details.png",
      "/assets/lashes-studio/lashes-studio-appointment-history.png",
      "/assets/lashes-studio/lashes-studio-services.png",
      "/assets/lashes-studio/lashes-studio-service-details.png",
